...
<html>
	<head>
		...
		<meta name="description" content="Taxi Boy - HTML Template">
		<meta name="hari" content="Coffeecream Themes, info@coffeecream.eu">
	...
	<body>
        ...
        <header class="header">
            ...
            <div id="nav-bar" class="nav-bar">
                <div class="container">
                    <a href="index.html" class="logo"><img src="images/logo.svg" alt="Taxi Boy - HTML Template" /></a>
